...
```bash
ls skills/ppt-master-richard/templates/icons/chunk-filled/ | grep home
ls skills/ppt-master-richard/templates/icons/tabler-filled/ | grep home
ls skills/ppt-master-richard/templates/icons/tabler-outline/ | grep chart
ls skills/ppt-master-richard/templates/icons/phosphor-duotone/ | grep house
ls skills/ppt-master-richard/templates/icons/simple-icons/ | grep github
```
