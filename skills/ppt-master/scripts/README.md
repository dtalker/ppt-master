...
| Media embedding | `embed_media.py` — embed playable video/audio into the exported PPTX (Step 7.4); audio auto-wraps to a poster video for Keynote | [../references/media-embedding.md](../references/media-embedding.md) |
