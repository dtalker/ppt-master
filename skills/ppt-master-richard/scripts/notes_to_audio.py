...
Usage:
    python3 skills/ppt-master-richard/scripts/notes_to_audio.py <project_path> --voice zh-CN-XiaoxiaoNeural
    python3 skills/ppt-master-richard/scripts/notes_to_audio.py <project_path> --provider elevenlabs --voice-id <voice_id>
    python3 skills/ppt-master-richard/scripts/notes_to_audio.py <project_path> --provider minimax --voice-id <voice_id>
    python3 skills/ppt-master-richard/scripts/notes_to_audio.py <project_path> --provider qwen --voice-id <voice>
    python3 skills/ppt-master-richard/scripts/notes_to_audio.py <project_path> --provider cosyvoice --voice-id <voice>
    python3 skills/ppt-master-richard/scripts/notes_to_audio.py --list-common-voices
    python3 skills/ppt-master-richard/scripts/notes_to_audio.py --list-voices --locale zh-CN
...
def main() -> int:
    ...
    if args.provider == "edge" and not args.voice:
        parser.error(
            ...
            "(e.g. --locale zh-CN), or follow skills/ppt-master-richard/workflows/generate-audio.md "
