---
name: ppt-master-richard
description: >
  AI-driven multi-format SVG content generation system (Richard's optimized fork of
  ppt-master, adds playable video/audio embedding + the eink-magazine visual style).
  Converts source documents (PDF/DOCX/URL/Markdown) into high-quality SVG pages and
  exports to PPTX through multi-role collaboration. Use when user asks to "create PPT",
  "make presentation", "生成PPT", "做PPT", "制作演示文稿", or mentions
  "ppt-master-richard" / "ppt-master".
---

# PPT Master (Richard's optimized fork) Skill
