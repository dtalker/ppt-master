...
```bash
python3 skills/ppt-master-richard/scripts/template_fill_pptx.py analyze "<project_dir>/sources/<source.pptx>" -o "<project_dir>/analysis/slide_library.json"
```
...
```bash
python3 skills/ppt-master-richard/scripts/template_fill_pptx.py scaffold "<project_dir>/analysis/slide_library.json" -o "<project_dir>/analysis/fill_plan.json" --slides "1,3,4"
```
...
```bash
python3 skills/ppt-master-richard/scripts/template_fill_pptx.py check-plan "<project_dir>/analysis/slide_library.json" "<project_dir>/analysis/fill_plan.json" -o "<project_dir>/analysis/check_report.json"
```
...
```bash
python3 skills/ppt-master-richard/scripts/template_fill_pptx.py apply "<project_dir>/sources/<source.pptx>" "<project_dir>/analysis/fill_plan.json" -o "<project_dir>/exports/<output.pptx>"
```
...
```bash
python3 skills/ppt-master-richard/scripts/source_to_md/ppt_to_md.py "<project_dir>/exports/<output.pptx>"
```
