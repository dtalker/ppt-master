...
python3 skills/ppt-master-richard/scripts/svg_editor/server.py <project_path> --no-browser
...
```bash
python3 skills/ppt-master-richard/scripts/visual_review.py <project_path>
```
...
- Path to the rubric: `skills/ppt-master-richard/references/visual-review.md`
